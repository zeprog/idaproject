    ...
    <div class="product__cart">
      <div class="cart__header">
        <div class="cart__rating">
          ...
          <p class="cart__rating-text">{{cart.rating}}</p>
        </div>
        <div class="cart__basket" @click="countIncrement">
      ...
      <div class="cart__img">
        <img :src="`https://frontend-test.idaproject.com${cart.photo}`"  alt="">
      </div>
      <p class="cart__title">{{ cart.name }}</p>
